...
import { LogoLight } from "../components/navbar/Logo";
import {
  navigationItems,
  contactInfo,
  socialLinks,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            ...
            <p className="text-white/70 text-sm leading-relaxed mb-6">
              Experience luxury aesthetic treatments in the heart of Kabul.
              Enhancing natural beauty with medical expertise.
            </p>
            ...
            <div className="flex items-center gap-3">
              {socialLinks.map((social) => (
                <a
                  ...
                  className="w-10 h-10 rounded-full bg-white/5 hover:bg-primary flex items-center justify-center transition-all duration-300 hover:scale-110"
          ...
          <div>
            ...
            <ul className="space-y-3">
              {[
                { label: "Facial Treatments", path: "/treatments" },
                { label: "Skin Rejuvenation", path: "/treatments" },
                { label: "Anti-Aging", path: "/treatments" },
                { label: "Laser Therapy", path: "/treatments" },
